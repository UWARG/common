...
class JetsonLandingInitiationCommand(object):
    ...
    def encode(self):
        buf = BytesIO()
        buf.write(JetsonLandingInitiationCommand._get_packed_fingerprint())
    ...
    def decode(data):
        if hasattr(data, 'read'):
            ...
            buf = BytesIO(data)
        if buf.read(8) != JetsonLandingInitiationCommand._get_packed_fingerprint():
            raise ValueError("Decode error")
        return JetsonLandingInitiationCommand._decode_one(buf)
    ...
    def _get_packed_fingerprint():
        if JetsonLandingInitiationCommand._packed_fingerprint is None:

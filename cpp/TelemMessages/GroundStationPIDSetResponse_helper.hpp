...
#include "GroundStationPIDSetResponse.hpp"
#include "CRC32.hpp"

namespace helpers
{

bool encodeGroundStationPIDSetResponse(TelemMessages::GroundStationPIDSetResponse msg, uint8_t* buf, int maxSize) {

    int size = sizeof(TelemMessages::GroundStationPIDSetResponse);
...
TelemMessages::GroundStationPIDSetResponse decodeGroundStationPIDSetResponse(uint8_t* buf, int maxSize) {

    int size = sizeof(TelemMessages::GroundStationPIDSetResponse);
    TelemMessages::GroundStationPIDSetResponse msg;
